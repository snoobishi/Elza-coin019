...
- **Admin Panel** - Manager account with special powers:
  ...
  - Withdraw earnings to Binance, Google Pay, or Moncash
...
```bash
MANAGER_USERNAME=Elzakarygustinvil019
...
- `POST /api/claims` - Request withdrawal
